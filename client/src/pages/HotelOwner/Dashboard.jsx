  ...
  return (
    <div>
      <Title
        ...
        title={"Dashboard"}
        subTitle={
          "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et exercitationem, accusantium labore laboriosam dolore optio ea assumenda rerum nam sunt omnis eveniet sed. "
        }
      />

      <div className="flex gap-4 my-8">
        {/* Total Booking */}
        <div className="bg-primary/5 border border-primary/10 rouned flex p-4 pr-8">
          <img
